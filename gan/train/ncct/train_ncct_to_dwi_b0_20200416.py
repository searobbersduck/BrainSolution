...
from datasets.ncct_gan_dataset import NCCT_GAN_DS
...
class Options():
    def __init__(self):
        ...
        self.config_file = '../../data/gan/ncct2dwi/experiment_registration2/8.out/config/ncct_to_dwi_bxxx_train_config_file.txt'
        self.check_point = None

def train():
    opt = Options()
    ds = NCCT_GAN_DS(opt.root_dir, 
    opt.config_file, 
