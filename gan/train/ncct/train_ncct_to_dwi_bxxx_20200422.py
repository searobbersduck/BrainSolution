...
class Options():
    def __init__(self):
        ...
        self.save_dir = '../../data/gan/ncct2dwi/experiment_registration2/9.model_out/model_{}'.format(__file__.split('.')[0])
        ...
        # self.netG_model_path = '../../data/gan/ncct2dwi/experiment_registration2/9.model_out/model_train_ncct_to_dwi_bxxx_20200421/pixel2pixel_netG_epoch_100_loss_32.1745.pth'
