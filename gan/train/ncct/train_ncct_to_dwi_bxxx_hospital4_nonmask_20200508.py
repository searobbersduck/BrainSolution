...
class Options():
    def __init__(self):
        ...
        self.intermidiate_result_root = '../../data/gan/hospital_4/experiment_registration2/8.2.out/train_result/intermidiate_result_{}'.format(__file__.split('.')[0])
        self.save_dir = '../../data/gan/hospital_4/experiment_registration2/9.2.model_out/model_{}'.format(__file__.split('.')[0])
        ...
        self.root_dir = '../../data/gan/hospital_4/experiment_registration2/8.2.out'
        self.config_file = '../../data/gan/hospital_4/experiment_registration2/8.2.out/config/mask_ncct_to_dwi_bxxx_train_config_file.txt'
        self.check_point = None
        # self.netG_model_path = '../../data/gan/hospital_4/experiment_registration2/9.model_out/model_train_ncct_to_dwi_bxxx_20200501/pixel2pixel_netG_epoch_250_loss_15.9175.pth'
