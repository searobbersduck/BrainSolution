...
from models.gan_3d_model import Pix2PixModel
...
class Options():
    def __init__(self):
        ...
        self.intermidiate_result_root = '../../data/gan/hospital_6_crop/experiment_registration2/8.3.out/train_result/intermidiate_result_{}'.format(__file__.split('.')[0])
        self.save_dir = '../../data/gan/hospital_6_crop/experiment_registration2/9.3.model_out/model_{}'.format(__file__.split('.')[0])
        ...
        self.netG_model_path = '../../data/gan/hospital_6_crop/experiment_registration2/9.3.model_out/model_train_cta_to_dwi_bxxx_hospital6_nonmask_skip_20200609/pixel2pixel_netG_epoch_1350_loss_4.6997.pth'
        self.netG_model_path = '../../data/gan/hospital_6_crop/experiment_registration2/9.3.model_out/model_train_cta_to_dwi_bxxx_hospital6_nonmask_skip_lbp_loss_20200615/pixel2pixel_netG_epoch_75_loss_14.0043.pth'
        self.netG_model_path = '../../data/gan/hospital_6_crop/experiment_registration2/9.3.model_out/model_train_cta_to_dwi_bxxx_hospital6_nonmask_skip_lbp_loss_20200615/pixel2pixel_netG_epoch_1750_loss_15.1692.pth'
...
def train():
    ...
    for epoch_i in range(opt.epochs):
        for index, (src_imgs, dst_imgs, mask_imgs, src_names, dst_names) in enumerate(dataloader):
            input = {}
            z = Variable(torch.from_numpy(np.random.normal(0,1, src_imgs.shape)).float())
            input['A'] = z
            input['B'] = src_imgs
