...
from datasets.cta_to_dwi_dataset import NCCT2DWI_GAN_DS
...
def train():
    opt = Options()
    ds = NCCT2DWI_GAN_DS('../data/gan/ncct2dwi/siyuan_NCCT-DWI-align/dwi_rigid_align_ncct_rescale', 
    '../data/gan/ncct2dwi/siyuan_NCCT-DWI-align/dwi_rigid_align_ncct_rescale/config/config_file_1.txt', 
