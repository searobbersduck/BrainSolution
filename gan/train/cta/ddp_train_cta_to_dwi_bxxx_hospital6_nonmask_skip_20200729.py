...
def train():
    ...
    # dataloader = DataLoader(ds, batch_size=opt.batch_size, sampler=sampler, drop_last=True)
    dataloader = DataLoader(ds, num_workers=opt.num_workers, batch_size=opt.batch_size, pin_memory=False, shuffle=True, drop_last=True)
