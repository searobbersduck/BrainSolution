    ...
    def __init__(self, opt):
        ...
        if self.isTrain:
            ...
            if self.opt.patch_D:
                ...
                # self.netD_P = self.netD_P_cpu.to(self.device)
                # self.netD_P = torch.nn.parallel.DistributedDataParallel(self.netD_P, device_ids=[self.local_rank], output_device=self.local_rank)
        ...
        # self.netD = torch.nn.parallel.DistributedDataParallel(self.netD, device_ids=[self.local_rank], output_device=self.local_rank)
