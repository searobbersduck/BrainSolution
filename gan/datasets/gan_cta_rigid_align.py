...
def multiprocess_main():
    ...
    moving_file_flag1 = r'FU_ADC.nii.gz'
    moving_file_flag2 = r'FU_DWI_B0.nii.gz'
    moving_file_flag3 = r'FU_DWI_BXXX.nii.gz'
...
def cta_dwi_multiprocess_main(base_dir):
    print('Python %s on %s' % (sys.version, sys.platform))

    # base_dir = r'/ssd2/zhangwd/data/brain/gan/ncct2dwi/experiment_registration2/'
    # base_dir = r'/ssd2/zhangwd/data/brain/gan/hospital_4/experiment_registration2/'
    input_dir = os.path.join(base_dir, '4 Patient_nii_unity')
    output_dir = os.path.join(base_dir, '5 dwi_rigid_align_ncct')
    ref_file_flag1 = r'BS_brain.nii.gz'
    ref_file_flag2 = r'BS_NCCT.nii.gz'
    # moving_file_flag1 = r'FU_ADC.nii.gz'
    # moving_file_flag2 = r'FU_DWI_B0.nii.gz'
    ...
    ref_files = list(zip(ref_files1, ref_files2))
    # moving_files = list(zip(moving_files1, moving_files2, moving_files3))
    moving_files = list(zip(moving_files3))
...
if __name__ == '__main__':
    # multiprocess_main()
    # singleprocess_main()
    cta_dwi_multiprocess_main('/ssd2/zhangwd/data/brain/gan/hospital_6_crop/experiment_registration3/')
