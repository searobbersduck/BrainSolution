...
# CUDA_VISIBLE_DEVICES=4 python gan_utils.py extract_cerebral_parenchyma_multiprocess '../data/gan/hospital_4_2_3d/experiment_registration2/4 Patient_nii_unity' '../data/gan/hospital_4_2_3d/experiment_registration2/4 Patient_nii_unity' _NCCT.nii.gz _brain.nii.gz
...
# python gan_utils.py rapid_extract_sumary_info_multiprocess '../data/gan/hospital_4_2_3d/0.raw_dcm' '../data/gan/hospital_4_2_3d/1.rapid'

# python gan_utils.py ncct_split_train_test_according_to_rapid_result '../data/gan/hospital_4_2_3d/experiment_registration2/8.8.out/config/mask_ncct_to_dwi_bxxx_train_config_file.txt' '../data/gan/hospital_4_2_3d/experiment_registration2/8.8.out/config/mask_ncct_to_dwi_bxxx_test_config_file.txt' '../data/gan/hospital_4_2_3d/1.rapid/config.txt'
# python gan_utils.py copy_infarct_data '../data/gan/hospital_4_2_3d/experiment_registration2/8.8.out' '../data/gan/hospital_4_2_3d/experiment_registration2/8.8.out_infarct' '../data/gan/hospital_4_2_3d/1.rapid/config.txt'

# python gan_utils.py extract_mpr_multiprocess '../data/gan/hospital_4_2_3d/experiment_registration2/8.8.out_infarct/DWI_BXXX' '../data/gan/hospital_4_2_3d/experiment_registration2/8.8.out_infarct/projection'
# python gan_utils.py extract_mpr_multiprocess '../data/gan/hospital_4_2_3d/experiment_registration2/8.8.out_infarct/NCCT' '../data/gan/hospital_4_2_3d/experiment_registration2/8.8.out_infarct/projection'
