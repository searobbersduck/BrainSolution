...
# python gan_utils.py ncct_set_original_point '../data/gan/hospital_6/experiment_registration2/1.nii_file' '../data/gan/hospital_6_crop/experiment_registration2/2.nii_file_ori'

# ln -s '/ssd2/zhangwd/data/brain/gan/hospital_6_crop/experiment_registration2/2.nii_file_ori' '/ssd2/zhangwd/data/brain/gan/hospital_6_crop/experiment_registration2/4 Patient_nii_unity'

# CUDA_VISIBLE_DEVICES=4 python gan_utils.py extract_cerebral_parenchyma_multiprocess '../data/gan/hospital_6_crop/experiment_registration2/4 Patient_nii_unity' '../data/gan/hospital_6_crop/experiment_registration2/4 Patient_nii_unity' _NCCT.nii.gz _brain.nii.gz

# python gan_utils.py change_names_batch '../data/gan/hospital_6_crop/experiment_registration2/4 Patient_nii_unity' '../data/gan/hospital_6_crop/experiment_registration2/4 Patient_nii_unity' '_NCCT.nii.gz' '_NCCT_bk.nii.gz'
# python gan_utils.py change_names_batch '../data/gan/hospital_6_crop/experiment_registration2/4 Patient_nii_unity' '../data/gan/hospital_6_crop/experiment_registration2/4 Patient_nii_unity' '_NCCT_crop.nii.gz' '_NCCT.nii.gz'
...
# cd ../data/gan/hospital_6_crop/experiment_registration2/8.2.out
# ln -s DWI_BXXX DWI_B0
# ln -s DWI_BXXX ADC
# cd -

# python gan_utils.py ncct_genereate_cta2dwi_config_file_with_cerebral_parenchyma ../data/gan/hospital_6_crop/experiment_registration2/8.2.out ../data/gan/hospital_6_crop/experiment_registration2/8.2.out/config

# python gan_utils.py extract_mpr_multiprocess '../data/gan/hospital_6_crop/experiment_registration2/8.2.out_infarct/DWI_BXXX' '../data/gan/hospital_6_crop/experiment_registration2/8.2.out_infarct/projection'