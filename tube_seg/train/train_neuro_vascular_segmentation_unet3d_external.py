...
def main():
    ...
    config['loaders']['train']['file_paths'] = ['../external_lib/pytorch-3dunet/resources/random3D.h5']
    config['loaders']['val']['file_paths'] = ['../external_lib/pytorch-3dunet/resources/random3D_val.h5']
    print(config['loaders']['train']['file_paths'])
